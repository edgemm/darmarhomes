...
<?php /*?><div class="portfolio"<?php if ( wm_meta_option( 'portfolio-filterable' ) ) echo ' id="portfolio-filterable"'; ?>>
	...
	if ( wm_meta_option( 'portfolio-title' ) || ! $hideFilterClass ) echo '<nav class="portfolio-nav' . $showFilterCats . '">';
		...
		echo '<ul class="filter' . $hideFilterClass . '">';
			...
			if ( wm_meta_option( 'portfolio-cat' ) && wm_meta_option( 'portfolio-filterable' ) ) {
				...
				if ( $term )
					echo '<li class="active all"><a href="#" data-id="all">' . sprintf( __( 'All %s', WM_THEME_TEXTDOMAIN ) , $term->name ) . '</a></li>';
			} elseif ( wm_meta_option( 'portfolio-filterable' ) ) {
				echo '<li class="active all"><a href="#" data-id="all">' . __( 'All %s', WM_THEME_TEXTDOMAIN ) . '</a></li>';
			}
